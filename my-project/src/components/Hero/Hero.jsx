            ...
            <div className = "container">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]'>
                    ...
                    <div className='text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28'>
                      <motion.h1 initial={{opacity: 0, y: -100}} animate={{opacity: 1, y: 0}} transition={{type: "spring", stiffness: 100, damping: 10, delay: 1}} className='text-7xl font-bold leading-tight ml-14'>Black Tumblr</motion.h1>
                      <motion.div initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{type: "spring", stiffness: 100, damping: 10, delay: 1.2}} className='relative'>
                        ...
                        <div className='absolute -top-6 -left-10 w-[330px] h-[240px] bg-gray-700/25'>
                    ...
                    <div className='relative'>
                      ...
                      <motion.div initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{type: "spring", stiffness: 100, damping: 10, delay: 0.8}} className='h-[180px] w-[180px] absolute top-24 -right-16 border-primary border-[20px] rounded-full z-10'>
                      </motion.div>
                      {/**Big text section */}
                    ...
                    {/**Third div section */}
                    <div className='text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28'>
                      <h1 className='opacity-0 text-7xl font-bold leading-tight ml-14'>Black Tumblr</h1>
                      <motion.div initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{type: "spring", stiffness: 100, damping: 10, delay: 1.2}}className='relative'>
                        <div className='relative z-10 space-y-4'>
                          <h1 className='text-2xl'>Black Tumblr</h1>
                        ...
                        <div className='absolute -top-6 -right-10 w-[330px] h-[240px] bg-darkGray/50'>
